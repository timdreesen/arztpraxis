    ...
    <section id="notfaelle" className="text-neutral-800 scroll-mt-24 pb-5">
      ...
      <div className="p-5 text-center flex flex-wrap gap-4 justify-center">
        <div className="max-w-sm shadow-md p-4">
          ...
          <p className="inline-block text-2xl font-bold border-danger border-2 text-neutral-800 px-4 py-2 tracking-widest">
            112
          </p>
        </div>
        <div className="max-w-sm shadow-md p-4">
          ...
          <p className="inline-block text-2xl font-bold border-secondary border-2 text-black  px-5 py-2  tracking-widest">
            116117
          </p>
        </div>
        <div className="max-w-sm shadow-md p-4">
          ...
          <p className="inline-block text-2xl font-semibold border-accent border-2 text-black  px-5 py-2 tracking-widest">
            0172 400 4554
          </p>
        </div>
      </div>
